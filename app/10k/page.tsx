          ...
          <div ref={primerContainerRef} className="border border-[#d0d7e8] rounded-lg overflow-hidden">
            <div className="px-5 py-4 bg-gradient-to-r from-[#0c1b38] to-[#152a55] flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button onClick={generatePrimer} disabled={primerRunning}
                  className="flex items-center gap-2 px-4 py-2 text-[11.5px] font-bold rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  style={{ background: "var(--ca-accent)", color: "var(--ca-accent-text)" }}>
                  {primerRunning
                    ? <><span className="w-3 h-3 border-2 border-t-transparent rounded-full animate-spin" style={{ borderColor: "var(--ca-accent-text)", borderTopColor: "transparent" }} /> Writing Primer…</>
            ...
            {primerRunning && (
              <div className="px-5 py-3 border-b border-gray-200 bg-gray-50">
                ...
                <div className="h-1.5 rounded-full overflow-hidden" style={{ background: "var(--ca-border)" }}>
                  <div className="h-full rounded-full transition-all duration-500"
                    style={{ width: `${Math.min(100, (primerText.length / 32000) * 100)}%`, background: "var(--ca-accent)" }} />
                </div>
              </div>
            )}
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            <div className="px-5 py-4 bg-gray-50 flex items-center justify-between gap-4 border-b border-gray-200">
              ...
              <button onClick={generateAI} disabled={aiRunning}
                className="flex items-center gap-2 px-4 py-2 text-[11.5px] font-semibold rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors shrink-0"
                style={{ background: "var(--ca-accent)", color: "var(--ca-accent-text)" }}>
                {aiRunning
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className={`flex gap-2 px-4 py-3 border-t border-gray-100 ${chatMsgs.length === 0 ? "" : "bg-white"}`}>
              ...
              <button
                ...
                className="px-3.5 py-2 rounded-lg disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center gap-1.5 text-[11.5px] font-semibold shrink-0"
                style={{ background: "var(--ca-accent)", color: "var(--ca-accent-text)" }}>
                {chatRunning
